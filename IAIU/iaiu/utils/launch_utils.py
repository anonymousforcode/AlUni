...
import iaiu
from iaiu.utils.logger import *
from iaiu.utils.initialize_utils import get_item, visit_all_items
import iaiu.torch_modules.utils as ptu
import warnings
import copy


_mbrl_project_dir = osp.join(os.path.dirname(iaiu.__file__), os.pardir)
...
def get_config_from_file(config_path):
    ...
    config = update_config(config, cmd_config)
    # changed
